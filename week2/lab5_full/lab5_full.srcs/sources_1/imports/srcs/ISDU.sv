...
//    also PC = PC + 1 happens in state 18
	enum logic [4:0] {  Halted, //0
						...
						PauseIR2, //2
						S_18,  //3
						S_33_1, //4 //memory fetch //extend to 3 states as explained above
						S_33_2, //5 //memory fetch
						S_33_3, //6 //commit MDR
						S_35, //7
						S_32, //8 
						S_01, //9
						...
						S_09, //11
						S_06, //12
						S_25_1, //13 //kinda the same as state 33 so we might be able to reduce the fsm states
						S_25_2, //14
						S_25_3, //15
						S_27, //16
						S_07, //17
						...
						State, Next_state;   // Internal state logic //BRZ when opcode is 0000
